...
*/
var aa=__webpack_require__(0),m=__webpack_require__(1),q=__webpack_require__(5);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
var App_App = /** @class */ (function () {
    ...
    App.run = function () {
        new service_WorklogSummarizer().register();
    };
    return App;
}());
/* harmony default export */ var service_App = (App_App);
